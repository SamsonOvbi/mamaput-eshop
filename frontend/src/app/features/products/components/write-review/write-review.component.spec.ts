...
describe('WriteReviewComponent', () => {
  ...
  beforeEach(async () => {
    ...
    snackbarServiceMock = jasmine.createSpyObj('SnackbarService', ['openSB']);
    sharedServiceMock = jasmine.createSpyObj('SharedService', [], { titleBlog: 'Test Blog' });
  ...
  it('should handle errors on getProduct failure', () => {
    ...
    expect(snackbarServiceMock.openSB).toHaveBeenCalledWith('Error', 'error');
  });
